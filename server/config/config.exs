...
config :boardr, Boardr, rules_factory: Boardr.Rules.DefaultFactory

config :boardr, Boardr.Auth.Token, private_key: nil
  ...
  http: [
    dispatch: [
      {:_,
       [
         {"/ws", BoardrApi.WsTest, []},
         {:_, Phoenix.Endpoint.Cowboy2Handler, {BoardrApi.Endpoint, []}}
       ]}
    ]
  ]
